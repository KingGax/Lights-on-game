...
public class ShaderPlayerTracker : MonoBehaviour {
    ...
    private GameObject p2LanternPos;
    private GameObject p1LanternPos;
        ...
        if (!initialised) {
            if (GlobalValues.Instance.players.Count >= numberOfPlayers) {
                if (numberOfPlayers == 2) {
                    ...
                    p2LanternPos = p2Lantern.gameObject;
                    twoPlayers = true;
                } else {
                ...
                p1LanternPos = p1Lantern.gameObject;
            ...
            if (twoPlayers) {
                ...
                shaderMaterial.SetVector("Vector3_1", p2LanternPos.transform.position);
            }
            shaderMaterial.SetVector("Vector3_8cf38a4ca0cb4f6589592a89d233cd7f", p1LanternPos.transform.position);
